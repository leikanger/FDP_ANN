...
% TODO 1) Lagre estimert tidspunkt i en double-variabel istadenfor en unsigned long: double dEstimatedTaskTime 		ikkje lenger ulEstimatedTaskTime..
% TODO 2) Lagre tidspunkt for start av 'time window' i en double istadenfor unsigned long: 	dStartOfTimeWindow 		ikkje lenger ulStartOfTimeWindow..
