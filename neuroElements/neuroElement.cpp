...
{ //{ ** AURON
	...
	ulEstimatedTaskTime_for_object = time_class::getTid() + (unsigned)dLastCalculatedPeriod;
...
{ //{
	...
	ulEstimatedTaskTime_for_object = time_class::getTid()+DEFAULT_PERIODE_MELLOM_RECALC_KAPPA;
} //}
